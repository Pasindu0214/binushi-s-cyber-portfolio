...
const PROFILE_IMAGE_URL = "Binushi Portfolio Picture.png";
    ...
    <section id="home" className="relative overflow-hidden" style={{ background: "var(--gradient-hero)" }}>
      ...
      <div className="hero-content relative max-w-6xl mx-auto px-6 py-24 md:py-32 grid md:grid-cols-[1.25fr_0.85fr] gap-12 items-center">
        <div className="hero-left">
          ...
          <p className="hero-subtitle mt-5 text-lg md:text-xl text-primary font-medium">Cyber Security Analyst</p>

          <p className="hero-description mt-5 max-w-xl text-muted-foreground leading-relaxed">
          ...
          <div className="hero-contact mt-10 flex flex-wrap gap-x-8 gap-y-3 text-sm text-muted-foreground">
            <span className="inline-flex items-center gap-2">
              <Mail className="w-4 h-4 text-primary" /> binutm126@gmail.com
            </span>
            <span className="inline-flex items-center gap-2">
              <Phone className="w-4 h-4 text-primary" /> +94 71 475 4271
            </span>
            <span className="inline-flex items-center gap-2">
        ...
        <div className="relative profile-print-card">
          <div className="profile-card glass rounded-3xl p-6 md:p-8 relative overflow-hidden border border-primary/20">
            <div className="absolute -top-24 -right-24 w-56 h-56 rounded-full bg-primary/15 blur-3xl no-print" />

            <div className="relative flex flex-col items-center text-center">
              <div className="profile-image-wrap w-56 h-56 md:w-72 md:h-72 rounded-full p-1 bg-gradient-to-br from-primary/80 via-primary/20 to-transparent shadow-2xl">
                <img
                  src={PROFILE_IMAGE_URL}
                  alt="Binushi Dimandi Muhandiram"
                  className="profile-image w-full h-full rounded-full object-cover border-4 border-background"
                />
              </div>

              <div className="profile-text mt-6">
                <h2 className="text-2xl font-bold">Binushi Dimandi</h2>
                <p className="text-primary text-sm mt-1">Cyber Security Analyst</p>
                <p className="text-muted-foreground text-sm mt-3 max-w-xs">
                  SOC professional focused on monitoring, incident response, CTI reporting, and continuous learning.
                </p>
              </div>

              <div className="profile-stats mt-6 grid grid-cols-2 gap-3 w-full text-xs">
                <div className="glass rounded-xl px-3 py-3">
                  <div className="text-primary font-semibold">SOC</div>
                  <div className="text-muted-foreground">Operations</div>
                </div>
                <div className="glass rounded-xl px-3 py-3">
                  <div className="text-primary font-semibold">SIEM</div>
                  <div className="text-muted-foreground">Monitoring</div>
                </div>
                <div className="glass rounded-xl px-3 py-3">
                  <div className="text-primary font-semibold">CTI</div>
                  <div className="text-muted-foreground">Reporting</div>
                </div>
                <div className="glass rounded-xl px-3 py-3">
                  <div className="text-primary font-semibold">IR</div>
  ...
  const phases = [
    ...
    },
    {
      ...
      items: [
        ...
        "Lead investigations and improve detection and response processes.",
      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-10">
          <p className="text-muted-foreground max-w-2xl">
            ...
            Services Provider. Skilled in SIEM, EDR/XDR, Microsoft Defender and Sentinel, Stella Cyber, incident response,
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {tools.map((t) => (
                <span
                  key={t}
                  className="text-xs font-mono px-3 py-1.5 rounded-full border border-border bg-secondary/50 text-foreground/90"
                >
                  {t}
                </span>
              ))}
        ...
        <div className="glass rounded-2xl p-6 mb-10">
          ...
          <div className="space-y-8 relative md:pl-6 md:before:absolute md:before:left-2 md:before:top-2 md:before:bottom-2 md:before:w-px md:before:bg-border">
            {[
              {
                role: "Associate Engineer — Information Security",
                org: "Dialog Axiata",
              ...
              },
              {
                ...
                items: [
                  ...
                  "Monitored and analyzed security events using SIEM, EDR, and Microsoft Sentinel.",
...
function Certifications() {
  const certs = [
    {
      title: "SOAR Analyst",
      issuer: "Certification Evidence 01",
    ...
    {
      title: "SOAR Fundamentals V6 (SFv6)",
      issuer: "Certification Evidence 02",
      ...
      @media print {
        * {
        ...
        #home {
          ...
          background: linear-gradient(135deg, #020b14 0%, #062033 55%, #020b14 100%) !important;
        }
